    ...
    <div class="page-container">
        <div class="cate-box">
          <div class="cate-box-inner" >
            <el-link type="primary" :underline="false" style="margin-right:12px;" >最新发布</el-link>
            ...
            <!-- <el-link type="default" :underline="false" style="margin-right:12px;" @click="$router.push({path:'/circle'})">
             ...
             <el-link type="default" :underline="false" style="float:right;margin-top:5px;" @click="$router.push({path:'/circle'})">
              <i class="el-icon-menu" style="position:relative;left:-4px;"></i>全部圈子
            </el-link>
          </div>
        </div>
            ...
            <div class="right-container">
                ...
                <div class="record-container">
                    ...
                    <div class="record-list">
                        <div> 
                            <div style="font-size:14px;color:#515767;height:80px;"> 
                ...
                <div class="record-container">
                    ...
                    <div class="record-list">
                        <p class="hot-article" v-for="(item,index) in huatiList" style="font-size:14px;" :key="index">
...
.club-container .news .content .text-container{
    color:#515767;
}
